    ...
    return (
      ...
      >
        <View style={styles.maincontainer}>
          ...
          <Logo />
          <Image
            source={require("../../assets/onboarding/set1.png")}
          ...
          <View style={styles.subcontainer}>
            ...
            >
              <TextBubble message="It's quick and easy..." />
              <TextBubble message="Profile yourself for insider access to the best properties,packages & perks in your city." />
            </View>
            <View
              style={{
                flex: 1,
