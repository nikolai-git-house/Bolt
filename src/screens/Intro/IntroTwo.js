    ...
    return (
      ...
      >
        <View style={styles.maincontainer}>
          ...
          <Logo />
          <Image
            source={require("../../assets/onboarding/set2.png")}
          ...
          <View style={styles.subcontainer}>
            ...
            >
              <TextBubble message="Your wish is our command..." />
              <TextBubble message="Access a personal concierge, ready to solve all of your key home & life needs." />
            </View>
            <View
              style={{
                flex: 1,
